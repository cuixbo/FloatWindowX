...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mSp = getSharedPreferences("float", MODE_PRIVATE);
...
//        tvText.setText(flag);
        ...
        floatConfig.setTouchActionUpListener(new TouchActionUpListener() {
            ...
            public boolean actionUp(@Nullable FloatViewController controller, MotionEvent event) {
                ...
                Log.e("FloatConfig:", "FloatConfig:" + mFloatConfig.getRawX() + "," + mFloatConfig.getRawY());
                saveXToSp(mFloatConfig.getRawX());
                saveYToSp(mFloatConfig.getRawY());
                return true;
            }
        });
    ...
    private void saveXToSp(int value) {
        mSp.edit().putInt("floatX", value).apply();
    }

    private void saveYToSp(int value) {
        mSp.edit().putInt("floatY", value).apply();
    }


    private int getXFromSp() {
        return mSp.getInt("floatX", 218);
    }


    private int getYFromSp() {
        return mSp.getInt("floatY", 1353);
    }
